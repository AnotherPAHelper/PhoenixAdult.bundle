...
def update(metadata,siteID,movieGenres,movieActors):
    ...
    # Title
    sceneTitle = detailsPageElements.xpath('//div[contains(@class,"custom-photo-movie-description")]//a')[0].text_content().strip()
    ...
    # Date
    date = detailsPageElements.xpath('//div[contains(@class,"custom-credits")]//li[1]')[0].text_content().replace("Released:","").strip()
    Log("Scene Date: " + date)
    ...
    actors = detailsPageElements.xpath('//div[contains(@class,"custom-credits")]//a')
    ...
    # Poster
    try:
            posterURL = detailsPageElements.xpath('//div[contains(@class,"custom-photo-movie")]//img')[0].get("src").split("thumb=")[1]
    except:
        posterURL = ''
